...
const talks = [
  ...
  { year: '2024', event: 'KCD Hyderabad', title: 'Keynote: Supply Chain Security in 2024', video: 'https://www.youtube.com/watch?v=T5Cm1Gj-0oA', type: 'keynote' },
  { year: '2024', event: 'ContainerDays', title: 'Building Scalable Cloud Native AI Apps with WebAssembly', video: 'https://youtu.be/tQYPcSGaAo4', type: 'talk' },
  { year: '2024', event: 'WasmCon', title: 'Exploring OpenTelemetry for Wasm', video: 'https://youtu.be/1zAsRC3q9D4', type: 'talk' },
  { year: '2024', event: 'Wasm I/O', title: 'Accelerating ML Inferencing with WebAssembly & Spin 2.0', video: 'https://www.youtube.com/watch?v=Ekwd46xfQ2s', type: 'talk' },
  { year: '2024', event: 'Civo Navigate US', title: 'Generative AI in the Kubernetes Era with Kubeflow', video: 'https://youtu.be/nXGHd8cBDno', type: 'talk' },
  { year: '2024', event: 'Civo Navigate US', title: 'Unveiling Civo\'s Latest Innovations and 2024 Roadmap', video: 'https://www.youtube.com/watch?v=C3tIQrobxic', type: 'talk' },
  { year: '2024', event: 'SOSS Community Days', title: 'Cooking up Secure OCI Artifacts with SLSA', video: 'https://www.youtube.com/watch?v=eD6dX-1jkb0', type: 'talk' },
  // 2023 and earlier
  ...
  { year: '2023', event: 'Civo Navigate EU', title: 'Build an App with Spin and Wasm (with Matt Butcher)', video: 'https://youtu.be/9I0QTZeFkok', type: 'talk' },
  { year: '2023', event: 'Civo Navigate EU', title: 'Discover Civo\'s Latest Cloud Solutions: Kubernetes, GPUs', video: 'https://www.youtube.com/watch?v=s7SQarXK0KM', type: 'talk' },
