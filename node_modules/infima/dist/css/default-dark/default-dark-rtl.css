...
:root {
  ...
  --ifm-code-background: rgb(62, 64, 66);
...
table thead tr {
    border-bottom-color: var(--ifm-table-border-color);
...
blockquote {
  ...
  border-style: solid;
  border-width: 0;
  border-right-width: var(--ifm-blockquote-border-left-width);
...
.avatar__photo + .avatar__intro {
      margin-right: var(--ifm-avatar-intro-margin);
    }
...
.avatar--vertical .avatar__intro {
      margin-right: 0; /* Reset the margin added in the horizontal layout. */
    }
...
.button-group > .button:not(:first-child) {
      ...
      margin-right: var(--ifm-button-group-margin);
    }
