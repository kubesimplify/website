...
const DocSidebarItemSchema = NavbarItemBaseSchema.append({
  type: _utilsValidation.Joi.string().equal('docSidebar').required(),
  sidebarId: _utilsValidation.Joi.string().required(),
  docsPluginId: _utilsValidation.Joi.string()
});
...
const ColorModeSchema = _utilsValidation.Joi.object({
  ...
  switchConfig: _utilsValidation.Joi.any().forbidden().messages({
...
const FooterLinkItemSchema = _utilsValidation.Joi.object({
  ...
  label: _utilsValidation.Joi.string()
}).xor('to', 'href', 'html').with('to', 'label').with('href', 'label').nand('html', 'label') // We allow any unknown attributes on the links (users may need additional
// attributes like target, aria-role, data-customAttribute...)
.unknown();
...
const ThemeConfigSchema = _utilsValidation.Joi.object({
  ...
  metadatas: _utilsValidation.Joi.any().forbidden().messages({
    'any.unknown': // cSpell:ignore metadatas
  ...
  autoCollapseSidebarCategories: _utilsValidation.Joi.bool().default(DEFAULT_CONFIG.autoCollapseSidebarCategories),
