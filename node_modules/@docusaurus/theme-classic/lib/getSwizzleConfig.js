  ...
  return {
    components: {
      ...
      DocSidebar: {
        actions: {
          eject: 'unsafe',
          // too much technical code in sidebar, not very safe atm
          wrap: 'safe'
        },
      ...
      'MDXComponents/Head': {
        ...
        description: 'Technical component used to assign metadata (generally for SEO purpose) to the current MDX document'
      },
