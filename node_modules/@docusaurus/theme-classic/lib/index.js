...
Object.defineProperty(exports, "getSwizzleConfig", {
  enumerable: true,
  get: function () {
    return _getSwizzleConfig.default;
  }
});
...
var _getSwizzleConfig = _interopRequireDefault(require("./getSwizzleConfig"));
...
const AnnouncementBarDismissDataAttribute = 'data-announcement-bar-initially-dismissed'; // We always render the announcement bar html on the server, to prevent layout
...
function docusaurusThemeClassic(context, options) {
  ...
  return {
    ...
    getClientModules() {
      const modules = [require.resolve(getInfimaCSSFile(direction)), './prism-include-languages', './admonitions.css'];
    ...
    configureWebpack() {
      ...
      return {
        plugins: [// This allows better optimization by only bundling those components
