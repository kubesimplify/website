...
const DebugLayout_1 = tslib_1.__importDefault(require("@theme/DebugLayout"));
const DebugJsonView_1 = tslib_1.__importDefault(require("@theme/DebugJsonView"));
...
function DebugContent({ allContent }) {
    return (react_1.default.createElement(DebugLayout_1.default, null,
        ...
        react_1.default.createElement("div", null, Object.entries(allContent)
            ...
            .filter(([, pluginContent]) => Object.values(pluginContent).some((instanceContent) => !!instanceContent))
