    ...
    <>
      <section className={styles.navbar}>
        <nav className={styles.navbar_positioning} >
            ...
            <ul className={isMobile ? styles.navbar_links_mobile : styles.navbar_links} onClick={() => setIsMobile(false)}>
              ...
              {isMobile ? (
                <>
                <li>
                  {mobileViewContent.learn}
                </li>
                <li >
                  {mobileViewContent.community}
                </li>
                </>
              ) : (
                <>
                <li className={styles.learn}>
                  {navbarContent.learn}
                </li>
              ...
              <li>
                <button className={styles.navbarbutton}><span className={styles.navbar_text}>Newsletter</span></button>
              </li>
            </ul>
