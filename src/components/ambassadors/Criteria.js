      ...
      <div>
        ...
        <div className={Styles.criteria_flex}>
          {criterias.map((criteria, index) =>  (
              <div className={Styles.criteria_items} key={index}>
                <img
                  className={Styles.criteria_items_img}
                  src={criteria.logo}
                  alt="error"
                />
                <h4 className={Styles.criteria_items_heading}>
                  {criteria.title}
                </h4>
                <span className={Styles.criteria_items_para}>
                  {criteria.para}
                </span>
              </div>
            )
