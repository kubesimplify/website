...
export const SERIES = [
  ...
  },
  {
    ...
    name: '7 Days of Local LLM',
    plannedTotal: 7,
    tagline: 'Running serious local LLMs hands-on on NVIDIA DGX Spark, from unboxing to 120B-parameter models.',
    description:
  ...
  {
    slug: 'big-llm-across-multiple-gpus',
    name: 'A big LLM across multiple GPUs',
    tagline: 'Serve a model too big for one GPU, then understand why it behaves the way it does.',
    description:
      "A two-part series on running a 235B model across four GPUs with vLLM. Part 1 is the runbook: download to serving in eight steps, with every flag, startup log line and real error explained. Part 2 is the machinery: how tensor, pipeline and expert parallelism split a model, why splitting a layer speeds up prefill but costs an all-reduce at every layer, and why NVLink decides which method wins.",
    author: 'shubham-katara',
    color: '#76B900',
    cover: null,
    posts: [
      'running-a-big-llm-across-multiple-gpus-with-vllm',
      'how-multi-gpu-llm-inference-actually-works',
    ],
  },
  {
