...
import HAMiBlastRadiusAnimation from '@/components/HAMiBlastRadiusAnimation';
import HAMiRequestFlowAnimation from '@/components/HAMiRequestFlowAnimation';
import HAMiSlotMathAnimation from '@/components/HAMiSlotMathAnimation';
import DynamicMigLifecycleAnimation from '@/components/DynamicMigLifecycleAnimation';
import MultiGpuSplitModesAnimation from '@/components/MultiGpuSplitModesAnimation';
import MultiGpuTensorSplitAnimation from '@/components/MultiGpuTensorSplitAnimation';
import MultiGpuMemoryFitAnimation from '@/components/MultiGpuMemoryFitAnimation';
import MoeExpertRoutingAnimation from '@/components/MoeExpertRoutingAnimation';
...
const BLOG_SHORTCODES = {
  ...
  '{{hami-blast-radius-animation}}': 'hami-blast-radius-animation',
  '{{hami-request-flow-animation}}': 'hami-request-flow-animation',
  '{{hami-slot-math-animation}}': 'hami-slot-math-animation',
  '{{dynamic-mig-lifecycle-animation}}': 'dynamic-mig-lifecycle-animation',
  '{{multi-gpu-split-modes-animation}}': 'multi-gpu-split-modes-animation',
  '{{multi-gpu-tensor-split-animation}}': 'multi-gpu-tensor-split-animation',
  '{{multi-gpu-memory-fit-animation}}': 'multi-gpu-memory-fit-animation',
  '{{moe-expert-routing-animation}}': 'moe-expert-routing-animation',
};
...
const processor = unified()
  ...
  // Materialize trusted raw HTML used by existing posts before rendering React.
  .use(rehypeRaw)
  .use(rehypeSlug)
  ...
  .use(rehypeReact, {
    ...
    components: {
      ...
      'hami-blast-radius-animation': HAMiBlastRadiusAnimation,
      'hami-request-flow-animation': HAMiRequestFlowAnimation,
      'hami-slot-math-animation': HAMiSlotMathAnimation,
      'dynamic-mig-lifecycle-animation': DynamicMigLifecycleAnimation,
      'multi-gpu-split-modes-animation': MultiGpuSplitModesAnimation,
      'multi-gpu-tensor-split-animation': MultiGpuTensorSplitAnimation,
      'multi-gpu-memory-fit-animation': MultiGpuMemoryFitAnimation,
      'moe-expert-routing-animation': MoeExpertRoutingAnimation,
      pre: CodeBlock,
    },
  });
 ...
 *   {{...-animation}}           → allow-listed blog visuals
