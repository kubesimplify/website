...
import TwoGpuTensorSplitAnimation from '@/components/TwoGpuTensorSplitAnimation';
import TwoGpuMemoryFitAnimation from '@/components/TwoGpuMemoryFitAnimation';
import TwoGpuTpVsPpAnimation from '@/components/TwoGpuTpVsPpAnimation';
...
const BLOG_SHORTCODES = {
  ...
  '{{two-gpu-tensor-split-animation}}': 'two-gpu-tensor-split-animation',
  '{{two-gpu-memory-fit-animation}}': 'two-gpu-memory-fit-animation',
  '{{two-gpu-tp-vs-pp-animation}}': 'two-gpu-tp-vs-pp-animation',
};
...
const processor = unified()
  ...
  .use(rehypeReact, {
    ...
    components: {
      ...
      'two-gpu-tensor-split-animation': TwoGpuTensorSplitAnimation,
      'two-gpu-memory-fit-animation': TwoGpuMemoryFitAnimation,
      'two-gpu-tp-vs-pp-animation': TwoGpuTpVsPpAnimation,
      pre: CodeBlock,
    },
  });
