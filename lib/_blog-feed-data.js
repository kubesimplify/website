...
export const FEED_POSTS = [
  {
    ...
    "description": "See how Kueue brings order to overloaded Kubernetes clusters by intelligently managing batch workloads with a hands on demo.",
  ...
  },
  {
    ...
    "description": "A 31 ms full-text search over 4.2 million Kubernetes log rows, and a whole cluster on 43m CPU under 600 MiB: a hands-on run of OpenObserve 1.0 as the backend.",
  ...
  },
  {
    ...
    "description": "A hands-on lab building a kagent AI agent on a local kind cluster with Ollama: read-only and write-capable agents, human-in-the-loop approval gates, and a practical guide for common issues.",
  ...
  },
  {
    ...
    "description": "A runbook for serving a model too big for one GPU: download to serving in seven steps, with every vLLM flag, startup log line and real error explained, plus tensor, pipeline and expert parallelism benchmarked head to head on a 235B model across four RTX PRO 6000 cards.",
  ...
  },
  {
    ...
    "description": "A hands-on comparison of Istio sidecar and ambient mode for zero-trust service mesh. Same app, same policy, two architectures proven step by step on a local cluster.",
